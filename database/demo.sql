...
UPDATE commodity SET effective_to = '2023-09-18 10:30:40.000' WHERE id = 13;
...
UPDATE commodity SET effective_to = '2023-09-18 10:30:40.000' WHERE id = 14;
...
INSERT INTO reference_data.dbo.commodity_code (id, code, suffix, description, parent_id, effective_from, effective_to, source_name, source_id) VALUES (9994048, N'0102211000', N'80', N'Heifers', 94047, N'2023-09-18 16:52:27.000', null, N'CUSTOM', N'1');
-- Expire old commodity row
UPDATE commodity SET effective_to = '2023-09-18 16:55:31.000' WHERE commodity_code = '94048';
-- Add new commodity
