...
INSERT INTO reference_data.dbo.commodity (certificate, commodity_code, species, effective_from, effective_to) VALUES
                                          (851, 94496, 3060353, N'2023-09-18 10:12:53.000', null);
-- Do a sync
-- In the frontend...
-- Check that Quinces (080840)
-- Check that species is Cydonia oblonga
-------------------------------------------------------------------------------------------------------------------------------------

-- Update the species on Quinces
UPDATE commodity SET effective_to = '2023-09-18 10:30:40.000' WHERE commodity_code = 94496;
INSERT INTO reference_data.dbo.commodity (certificate, commodity_code, species, effective_from, effective_to) VALUES
                                          (851, 94496, 3060354, N'2023-09-18 11:52:08.000', null);
-- Do a sync
-- In the frontend...
-- Check that species is Cydonia sp.
-------------------------------------------------------------------------------------------------------------------------------------
